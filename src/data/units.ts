...
// 8 units, 40 skill nodes. Nodes are authored without positions / derived id
// lists; buildCourse fills vocabularyIds, flashcardIds, task ids and layout.
...
export const units: Unit[] = [
  { id: 'u1', order: 1, title: 'First contact', goal: 'Open and close a basic conversation.' },
  { id: 'u2', order: 2, title: 'Survival basics', goal: 'Handle numbers, time and dates.' },
  { id: 'u3', order: 3, title: 'Personal information', goal: 'Talk about yourself and family.' },
  { id: 'u4', order: 4, title: 'Food and drink', goal: 'Order, pay and state preferences.' },
  { id: 'u5', order: 5, title: 'Places and directions', goal: 'Find your way and use transport.' },
  { id: 'u6', order: 6, title: 'Daily life', goal: 'Describe routines and simple plans.' },
  { id: 'u7', order: 7, title: 'Shopping and problems', goal: 'Buy things and ask for help.' },
  { id: 'u8', order: 8, title: 'A1 consolidation', goal: 'Put it together in real situations.' },
];

export const nodeSeeds: NodeSeed[] = [
  // Unit 1 — First contact
  { id: 'greetings', unitId: 'u1', title: 'Greetings', goal: 'Greet someone and say goodbye.', prerequisites: [], grammarIds: ['subject-pronouns'] },
  ...
  { id: 'numbers', unitId: 'u2', title: 'Numbers 0 to 100', goal: 'Count and read numbers.', prerequisites: ['yesno'], grammarIds: ['numbers-agreement'] },
  ...
  { id: 'present-ar', unitId: 'u6', title: 'Regular -ar verbs', goal: 'Conjugate -ar verbs in present.', prerequisites: ['common-verbs'], grammarIds: ['ar-verbs', 'present-basics'] },
